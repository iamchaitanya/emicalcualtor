        ...
        <div className="container">
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>
             <div style={{ display: 'flex', alignItems: 'center', gap: '10px', opacity: 0.8 }}>
                ...
                <span style={{ fontSize: '14px', fontWeight: 800, color: '#1e293b' }}>EMI Calculator</span>
            </div>
            <span style={{ fontSize: '13px', color: '#94a3b8' }}>© {new Date().getFullYear()} EMI Calculator. All rights reserved.</span>
          </div>
        </div>
      </div>
    </div>
